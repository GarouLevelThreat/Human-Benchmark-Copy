...
import TestInfo from "../../Common Components/Test Info/TestInfo";
              ...
              <div className="start-screen">
                <div className="start-screen-container">
                  ...
                  <div className="info-container">
                    <p className="info">Measure your abilities with brain games and cognitive tests.</p>
                  </div>
                  <button className="start-btn" onClick={() => setStart(true)}>Get Started</button>
                </div>
              </div>
            </>
          ) : (
            ...
            <div className="container">
              <div className="cards-container">
                <div className="cards-row">
                  ...
                  <Card index={1} onClick={() => setIndex(1)} newBubble={true}/>
                  <Card index={2} onClick={() => setIndex(2)} newBubble={true}/>
                </div>
                <div className="cards-row">
